...
# New menu item callback
def new_file():
    scr.delete(1.0, tk.END)  # Clear the scrolled text area

# Exit menu item callback
def exit_app():
    win.quit()  # Close the application
...
if __name__ == '__main__':
    ...
    file_menu.add_command(label="Exit", command=exit_app)  # Removed separator
    ...
    name_entered.grid(column=0, row=1, sticky=tk.W)  # Sticky set to W to align left
    name_entered.focus()
    ...
    # LabelFrame for containing labels
